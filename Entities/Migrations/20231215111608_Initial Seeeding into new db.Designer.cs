...
namespace Entities.Migrations
{
    ...
    [Migration("20231215111608_Initial Seeeding into new db")]
    partial class InitialSeeedingintonewdb
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.FeatureClass", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 12, 15, 16, 46, 8, 725, DateTimeKind.Local).AddTicks(6093),
                            EntityName = "Driver",
                        ...
                        new
                        {
                            ...
                            AdminComments = "good",
                            ApprovalStatus = (byte)0,
                            CreatedAt = new DateTime(2023, 12, 15, 16, 46, 8, 725, DateTimeKind.Local).AddTicks(6105),
                            EntityName = "Driver",
                            FeatureDataType = "int",
                        ...
                        new
                        {
                            ...
                            AdminComments = "good",
                            ApprovalStatus = (byte)0,
                            CreatedAt = new DateTime(2023, 12, 15, 16, 46, 8, 725, DateTimeKind.Local).AddTicks(6106),
                            EntityName = "Character",
                            FeatureDataType = "double",
                            FeatureName = "Height",
                            UserName = "kunal",
                        ...
                        new
                        {
                            ...
                            AdminComments = "good",
                            ApprovalStatus = (byte)0,
                            CreatedAt = new DateTime(2023, 12, 15, 16, 46, 8, 725, DateTimeKind.Local).AddTicks(6108),
                            EntityName = "Character",
                            FeatureDataType = "double",
                            FeatureName = "Width",
                            UserName = "kunal",
                        ...
                        new
                        {
                            ...
                            AdminComments = "good",
                            ApprovalStatus = (byte)0,
                            CreatedAt = new DateTime(2023, 12, 15, 16, 46, 8, 725, DateTimeKind.Local).AddTicks(6109),
                            EntityName = "Stock",
                            FeatureDataType = "double",
                            FeatureName = "Price",
                            UserName = "kunal",
